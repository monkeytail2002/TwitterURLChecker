...
<title>Manage Users | Security Suite</title>
</head>
<body>
...
<?php
		...
		$post_action = mysqli_real_escape_string($conn,$_POST['actionlist']);
		$user_list = mysqli_real_escape_string($conn,$_POST['userlist']);
		$_SESSION['post'] = $post_action;
		$session_id = $_SESSION['UserId'];
		$_SESSION['promuser'] = $user_list;
