...
<!-- Calls function -->
<?php $posts = getVirusTotalPosts(); ?>


	<title>VirusTotal Reports | Security Suite</title>
</head>
<body>
	...
	<div class="container">
		...
		<div class="content">
            ...
            <div class="post" style="margin-left: 0px;">
                ...
                <a href="single_report.php?post-slug=<?php echo $post['VTScanURL']; ?>">
                    <div class="post_info">
                        <h3><?php echo $post['VTReportName']; ?></h3>
                        <div class="info">
